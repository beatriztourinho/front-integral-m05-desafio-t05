...
**Repositório de Backend**: https://github.com/raniererocha/back-integral-m05-desafio-t05

**Repositório de Frontend**: https://github.com/raniererocha/front-integral-m05-desafio-t05

**URL do Backend**: https://charges-be.herokuapp.com/

**URL da aplicação funcionando**: https://charge-fe.netlify.app/

---

E os itens abaixo, que deverão ser preenchidos apenas após a finalização de todas as sprints do projeto: 

**Pull Request (PR) de Backend**: https://github.com/cubos-academy/back-integral-m05-desafio-t05/pull/58

**Pull Request (PR) de Frontend**: https://github.com/cubos-academy/front-integral-m05-desafio-t05/pull/63
